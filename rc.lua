...
local editor       = os.getenv("EDITOR") or "emacs" or "nano"
...
awful.util.taglist_buttons = awful.util.table.join(
   ...
   awful.button({ }, 6, awful.tag.viewtoggle),
   awful.button({ }, 7, awful.tag.viewtoggle),
   awful.button({ }, 8, awful.tag.viewtoggle)
